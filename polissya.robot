...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'polissya_Viewer'  Login  ${username}
...
Завантажити документ
  ...
  polissya.Пошук тендера по ідентифікатору  ${username}  ${TENDER}
...
Скасувати закупівлю
  ...
  polissya.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
...
Отримати інформацію із предмету
  ...
  ${return_value}=  polissya.Отримати інформацію з поля предмету  ${username}  ${tender_uaid}  ${item_id}  ${field_name}
  [return]  ${return_value}

Отримати інформацію з поля предмету
  [Arguments]  ${username}  ${tender_uaid}  ${item_id}  ${field_name}
  ${return_value}=  polissya.Отримати інформацію із тендера  ${username}  ${tender_uaid}  items[${item_id}].${field_name}
  [return]  ${return_value}
...
Завантажити документ в тендер з типом
  ...
  polissya.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  polissya.Завантажити документ до форми з типом  ${username}  ${tender_uaid}  ${filepath}  ${doc_type}
...
Завантажити ілюстрацію
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  polissya.Завантажити документ в тендер з типом  ${username}  ${tender_uaid}  ${filepath}  illustration
...
Додати публічний паспорт активу
  [Arguments]  ${username}  ${tender_uaid}  ${vdr_url}
  polissya.Завантажити документ в тендер з типом  ${username}  ${tender_uaid}  ${filepath}  x_dgfPublicAssetCertificate

Додати офлайн документ
  [Arguments]  ${username}  ${tender_uaid}  ${accessDetails}
  polissya.Завантажити документ в тендер з типом  ${username}  ${tender_uaid}  ${filepath}  x_dgfAssetFamiliarization
...
Додати предмет закупівлі
  ...
  polissya.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  ${index}=  polissya.Отримати кількість предметів в тендері  ${username}  ${tender_uaid}
...
Отримати документ
  ...
  Run Keyword If  ${SEARCH_MODE}=='assets'  polissya.Пошук об’єкта МП по ідентифікатору  ${username}  ${tender_uaid}
  ...  ELSE IF  ${SEARCH_MODE}=='lots'  polissya.Пошук лоту по ідентифікатору  ${username}  ${tender_uaid}
  ...  ELSE  polissya.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
...
Дискваліфікувати постачальника
  ...
  polissya.Оновити сторінку з тендером  ${username}  ${tender_uaid}
  ${award_index}=  inc  ${award_index}
...
Отримати інформацію із об'єкта МП
  ...
  ${return_value}=  Run Keyword  polissya.Отримати інформацію про ${fieldname}
  [return]  ${return_value}

Отримати інформацію з активу об'єкта МП
  [Arguments]  ${username}  ${asset_uaid}  ${item_id}  ${field_name}
  ${return_value}=   Run KeyWord   polissya.Отримати інформацію з поля предмету  ${username}  ${asset_uaid}  ${item_id}  ${field_name}
  [Return]  ${return_value}

Внести зміни в об'єкт МП
  [Arguments]  ${username}  ${asset_uaid}  ${fieldname}  ${fieldvalue}
  polissya.Пошук об’єкта МП по ідентифікатору  ${username}  ${asset_uaid}
  Run KeyWord  polissya.Внести зміни в об'єкт МП поле  ${fieldname}  ${fieldvalue}
  Click Element  id=btnPublic

Внести зміни в об'єкт МП поле 
  [Arguments]  ${fieldname}  ${fieldvalue}
  polissya.Внести зміни до елементу за шляхом  //*[@name = '${fieldname}']  ${fieldname}  ${fieldvalue}

Внести зміни в актив об'єкта МП
  [Arguments]  ${username}  ${item_id}  ${asset_uaid}  ${fieldname}  ${fieldvalue}
  polissya.Пошук об’єкта МП по ідентифікатору  ${username}  ${asset_uaid}
  Run KeyWord  polissya.Внести зміни до елементу за шляхом  //div[starts-with(@id, 'pn_w_item') and contains(@class, '${item_id}')]//*[@name= '${fieldname}']  ${fieldname}  ${fieldvalue}
  Click Element  id=btnPublic
...
Завантажити документ в об'єкт МП з типом
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}  ${doc_type}
  polissya.Пошук об’єкта МП по ідентифікатору  ${username}  ${tender_uaid}
  polissya.Завантажити документ до форми з типом  ${username}  ${tender_uaid}  ${filepath}  ${doc_type}

Завантажити ілюстрацію в об'єкт МП
  [Arguments]  ${username}  ${asset_uaid}  ${filepath}
  polissya.Завантажити документ в об'єкт МП з типом  ${username}  ${asset_uaid}  ${filepath}  illustration

Завантажити документ для видалення об'єкта МП
  [Arguments]  ${username}  ${asset_uaid}  ${filepath}
  polissya.Завантажити документ в об'єкт МП з типом  ${username}  ${asset_uaid}  ${filepath}  cancellationDetails
...
Додати умови проведення аукціону номер 0
  ...
  polissya.Пошук лоту по ідентифікатору  ${username}  ${lot_uaid}
...
Оновити сторінку з об'єктом МП
  [Arguments]  ${username}  ${lot_uaid}
  polissya.Пошук об’єкта МП по ідентифікатору  ${username}  ${lot_uaid}
...
Отримати інформацію з активу лоту
  ...
  ${return_value}=   Run KeyWord   polissya.Отримати інформацію з поля предмету  ${username}  ${lot_uaid}  ${item_id}  ${field_name}
  [Return]  ${return_value}

Завантажити документ в лот з типом
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}  ${doc_type}
  polissya.Пошук лоту по ідентифікатору  ${username}  ${tender_uaid}
  polissya.Завантажити документ до форми з типом  ${username}  ${tender_uaid}  ${filepath}  ${doc_type}
...
Завантажити ілюстрацію в лот
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  polissya.Завантажити документ в лот з типом  ${username}  ${tender_uaid}  ${filepath}  illustration

Завантажити документ для видалення лоту
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  polissya.Завантажити документ в лот з типом  ${username}  ${tender_uaid}  ${filepath}  cancellationDetails
...
Внести зміни в лот
  [Arguments]  ${username}  ${tender_uaid}  ${fieldname}  ${fieldvalue}
  polissya.Пошук лоту по ідентифікатору  ${username}  ${tender_uaid}
  Run KeyWord  polissya.Внести зміни в лот поле  ${fieldname}  ${fieldvalue}
  Click Element  id=btnPublic
...
Внести зміни в умови проведення аукціону
  ...
  polissya.Пошук лоту по ідентифікатору  ${username}  ${tender_uaid}
  Run Keyword If  '${fieldname}' == 'auctionPeriod.startDate'  polissya.Внести дату та час  _auction_${item_id}_auctionPeriod_startDate  ${fieldvalue}
  ...  ELSE  polissya.Внести зміни до елементу за шляхом  //*[@name= 'auctions[${item_id}].${fieldname}']  ${fieldname}  ${fieldvalue}
  Click Element  id=btnPublic
...
Активувати контракт
  ...
  Sleep   60
  polissya.Пошук договору по ідентифікатору  ${username}  ${contract_uaid}
...
Отримати інформацію із договору
  ...
  polissya.Пошук договору по ідентифікатору  ${username}  ${contract_uaid}
  ${return_value}=  Run Keyword  polissya.Отримати інформацію про contract_${fieldname}
  [return]  ${return_value}

Отримати інформацію з активу в договорі
  [Arguments]  ${username}  ${contract_uaid}  ${item_id}  ${field_name}
  polissya.Пошук договору по ідентифікатору  ${username}  ${contract_uaid}
  ${return_value}=   Run KeyWord   polissya.Отримати інформацію з поля предмету  ${username}  ${contract_uaid}  ${item_id}  ${field_name}
  [Return]  ${return_value}
